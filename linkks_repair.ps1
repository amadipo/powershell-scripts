...
if(!(Test-Path -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Microsoft Edge.lnk")){  
 $ComObj = New-Object -ComObject WScript.Shell
    ...
    $ComObj = New-Object -ComObject WScript.Shell
    $ShortCut = $ComObj.CreateShortcut("C:\Users\Public\desktop\VS code.lnk")
    ...
    $ComObj = New-Object -ComObject WScript.Shell
    $ShortCut = $ComObj.CreateShortcut("C:\Users\Public\desktop\PingID.lnk")
    $ShortCut.TargetPath = "C:\Program Files (x86)\Ping Identity\PingID\pingID.exe"
    $ShortCut.Description = "pingID"
    $ShortCut.FullName 
    $ShortCut.WindowStyle = 1
    $ShortCut.Save()
    ...
    $ComObj = New-Object -ComObject WScript.Shell
    $ShortCut = $ComObj.CreateShortcut("C:\Users\Public\desktop\pulse secure.lnk")
    $ShortCut.TargetPath = "C:\Program Files (x86)\Common Files\Pulse Secure\JamUI\pulse.exe"
    $ShortCut.Description = "pulse secure"
    $ShortCut.FullName 
    $ShortCut.WindowStyle = 1
    $ShortCut.Save()
}